...
>
  <!-- scanlines -->
  <div
    style="position:absolute;inset:0;pointer-events:none;background:repeating-linear-gradient(0deg,rgba(0,0,0,0.05) 0px,rgba(0,0,0,0.05) 1px,transparent 1px,transparent 3px);"
  ></div>

  <!-- bg glow -->
  <div
    style="position:absolute;bottom:-10rem;left:50%;transform:translateX(-50%);width:40rem;height:20rem;background:radial-gradient(ellipse,rgba(255,0,255,0.08) 0%,transparent 70%);pointer-events:none;"
  ></div>

  <div
    style="max-width:800px;margin:0 auto;text-align:center;position:relative;z-index:1;"
  >
    <p
      class="c-reveal"
      style="font-size:0.65rem;letter-spacing:0.25em;text-transform:uppercase;color:#ff00ff88;font-weight:700;text-shadow:0 0 10px #ff00ff;margin-bottom:1.5rem;"
    >
      Get in touch
    </p>
    ...
    >
      Let's build/work<br />
      <span style="color:#ff00ff;text-shadow:0 0 30px #ff00ff;">together.</span>
    </h2>

    <p
      class="c-reveal"
      style="font-size:0.95rem;color:rgba(255,200,255,0.45);margin-bottom:3rem;line-height:1.6;"
    >
      Got a project in mind? Looking for a fullstack engineer?<br />Drop me a
      line — I reply fast.
    </p>
    ...
    >
      ...
      <a
        href="https://www.linkedin.com/in/zolt%C3%A1n-debreceni-56092a1b8/"
        target="_blank"
